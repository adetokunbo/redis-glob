{
  ...
  # Pin hackage-nix to the potentially more recent version of hackage (as if 2026/06/24)
  hackage-nix-commit = "f118693f7a5ba47711714782c05d6a0108f707a2";
  ...
  index-state = "2026-06-24T00:00:00Z";
}
